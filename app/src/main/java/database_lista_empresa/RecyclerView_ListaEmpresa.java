...
public class RecyclerView_ListaEmpresa extends RecyclerView.Adapter<RecyclerView_ListaEmpresa.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.database_lista_empresa_conteudo_recycleview,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            textView_Nome = (TextView)itemView.findViewById(R.id.textView_ListaEmpresa_Item_Nome);
